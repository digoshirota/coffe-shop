      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <div className="flex gap-6 text-sm font-medium justify-center">
            <button className="border-t border-white pt-2">Book a Table</button>
            <button className="border-t border-white pt-2">View Menu</button>
          </div>
        </div>
  
        {/* Textos rotacionados nas laterais */}
        <div className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 rotate-[-90deg] text-[10px] tracking-wide">
          OPENING HOURS: 18:00 - 02:00
        </div>
        <div className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 rotate-90 text-[10px] tracking-wide">
          OPENING HOURS: 18:00 - 02:00
        </div>
